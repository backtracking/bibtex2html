...
references read from bib files. The result will be a file containing
all the keys of entries that satisfy the condition. This file is
...
String & \rightarrow & \verb|"| [\hat{}\verb|"|]^* \verb|"| \\
...
The following command reads input files \verb|bilbio.bib| and select
